        ...
        <Card>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-1">
                <li>{isPt
                  ? 'Na máxima extensão permitida por lei, a Empresa não será responsável por danos indiretos, incidentais, especiais ou consequenciais, incluindo perda de receitas, lucros cessantes ou interrupção de negócio.'
                  : 'To the maximum extent permitted by law, the Company shall not be liable for indirect, incidental, special or consequential damages, including loss of revenue, lost profits or business interruption.'}</li>
                <li>{isPt
                  ? 'Qualquer reclamação de responsabilidade deverá ser fundamentada com prova documental de dano direto e comprovadamente grave que comprometa seriamente a operação do negócio do Cliente.'
                  : 'Any liability claim must be supported by documented evidence of direct and demonstrably serious damage that significantly compromises the Customer\'s business operations.'}</li>
                <li>{isPt
                  ? 'A responsabilidade total da Empresa, em qualquer circunstância, está limitada ao valor das taxas efetivamente pagas pelo Cliente nos últimos 3 meses anteriores ao evento que originou a reclamação.'
                  : 'The Company\'s total liability, under any circumstances, is limited to the fees actually paid by the Customer in the 3 months preceding the event giving rise to the claim.'}</li>
                <li>{isPt
                  ? 'Não serão aceites reclamações baseadas em análises, relatórios ou métricas geradas automaticamente pela plataforma que não reflitam um prejuízo financeiro direto e documentado.'
                  : 'Claims based on analyses, reports or metrics automatically generated by the platform that do not reflect a direct and documented financial loss will not be accepted.'}</li>
              </ul>
            </section>
