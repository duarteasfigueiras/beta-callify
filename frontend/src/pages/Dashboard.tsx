      ...
      <div className="flex-1 grid grid-rows-2 gap-3 min-h-0">
        ...
        <div className="grid grid-cols-2 gap-3 min-h-0">
          <Card className="flex flex-col min-h-0">
            <CardHeader className="py-2 px-4 shrink-0">
              <CardTitle className="text-2xl">{t('dashboard.recentCalls')}</CardTitle>
            </CardHeader>
          ...
          <Card className="flex flex-col min-h-0">
            <CardHeader className="py-2 px-4 shrink-0">
              <CardTitle className="text-2xl">{t('alerts.title')}</CardTitle>
            </CardHeader>
            <CardContent className="flex-1 min-h-0 overflow-y-auto p-2 ">
              {alerts.length === 0 ? (
                <div className="h-full flex items-center justify-center text-gray-500 dark:text-gray-400 text-sm">
        ...
        <div className="grid grid-cols-2 gap-3 min-h-0">
          <Card className="flex flex-col min-h-0 cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/score-evolution')}>
            <CardHeader className="py-2 px-4 shrink-0">
              <CardTitle className="text-2xl">{t('dashboard.scoreEvolution')}</CardTitle>
            </CardHeader>
          ...
          <Card className="flex flex-col min-h-0">
            <CardHeader className="py-2 px-4 shrink-0 flex flex-row items-center justify-between">
              <CardTitle className="text-2xl">{t('dashboard.topReasons')}</CardTitle>
              <button
